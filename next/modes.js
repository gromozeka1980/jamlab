...
export const MODES = {
  ...
  gamelan: {
    ...
    kind:'scale', scales:{pelogLima:[0,1,3,7,8], pelogBarang:[0,2,5,7,9], slendro:[0,2,5,7,10]},
    // true (non-tempered) tunings in cents — gamelan doesn't fit 12-TET.
    // Pelog is a 7-note tuning (~[0,120,270,540,670,785,1050]); each patet plays only 5 of the 7:
    //   lima = degrees 1·2·3·5·6, barang = 2·3·5·6·7 (transposed to its own tonic).
    // Slendro is its own 5 equal steps (octave/5). scales[] above are 12-TET fallbacks for note-name labels.
    centScales:{pelogLima:[0,120,270,670,785], pelogBarang:[0,150,550,665,930], slendro:[0,240,480,720,960]},
    ombak:6,                                   // detune (cents) between paired resonators → the shimmering "waves"
    noBend:true,                               // struck metallophones can't be bent
    variants:[{id:'pelogLima',label:'variant.pelogLima'},{id:'pelogBarang',label:'variant.pelogBarang'},{id:'slendro',label:'variant.slendro'}], defVariant:'pelogLima',
  ...
  koto: {
    ...
    backings:[{id:'drone',label:'backing.drone',pad:1},{id:'arp',label:'backing.arp',arp:1},{id:'both',label:'backing.both',pad:1,arp:1},{id:'padperc',label:'backing.koto.padperc',pad:1,perc:1,bass:1},{id:'arpperc',label:'backing.koto.arpperc',arp:1,perc:1,bass:1},{id:'arpU',label:'backing.arpU',arp:1,arpU:1,perc:1,bass:1},{id:'arpW',label:'backing.arpW',arp:1,shape:'waves',perc:1,bass:1},{id:'arpP',label:'backing.arpP',arp:1,shape:'pulse',perc:1,bass:1}], defBacking:'arpperc',
  },
  vostok: {
    ...
    backings:[{id:'drone',label:'backing.drone',pad:1},{id:'padperc',label:'backing.vostok.padperc',pad:1,perc:1,bass:1},{id:'arpperc',label:'backing.vostok.arpperc',arp:1,perc:1,bass:1},{id:'vamp',label:'backing.vostok.vamp',vamp:1,arp:1,perc:1,bass:1},{id:'arpU',label:'backing.arpU',arp:1,arpU:1,perc:1,bass:1},{id:'arpW',label:'backing.arpW',arp:1,shape:'waves',perc:1,bass:1},{id:'arpP',label:'backing.arpP',arp:1,shape:'pulse',perc:1,bass:1}], defBacking:'arpperc',
  },
  light: {
    ...
    backings:[{id:'drone',label:'backing.drone',pad:1},{id:'arp',label:'backing.arp',arp:1},{id:'padperc',label:'backing.light.padperc',pad:1,perc:1,bass:1},{id:'arpperc',label:'backing.light.arpperc',arp:1,perc:1,bass:1},{id:'arpU',label:'backing.arpU',arp:1,arpU:1,perc:1,bass:1},{id:'arpW',label:'backing.arpW',arp:1,shape:'waves',perc:1,bass:1},{id:'arpP',label:'backing.arpP',arp:1,shape:'pulse',perc:1,bass:1}], defBacking:'arpperc',
  },
  synth: {
...
export const ARP_SHAPES={
  ...
  // (dropped "fall" [12,5,0,5]: as an infinite loop it's a cyclic rotation of the classic [0,5,12,5] → identical)
};
