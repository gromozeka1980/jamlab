...
const X = {
  en: {
    ...
    'ctl.instr':'Instrument','instr.original':'Original',
    'instr.piano':'Grand piano','instr.epiano':'E-piano','instr.harpsi':'Harpsichord','instr.celesta':'Celesta','instr.musicbox':'Music box','instr.vibes':'Vibraphone','instr.marimba':'Marimba','instr.glock':'Glockenspiel','instr.kalimba':'Kalimba','instr.organ':'Organ','instr.accordion':'Accordion','instr.nylon':'Nylon guitar','instr.steel':'Steel guitar','instr.harp':'Harp','instr.sitar':'Sitar','instr.koto':'Koto','instr.shamisen':'Shamisen','instr.strings':'Strings','instr.choir':'Choir','instr.flute':'Flute','instr.panflute':'Pan flute','instr.shaku':'Shakuhachi','instr.clarinet':'Clarinet','instr.sax':'Sax','instr.trumpet':'Trumpet',
