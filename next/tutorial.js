...
const X = {
  en: {
    ...
    'howit.p3':'Jamlab keeps only the notes of the style you chose. Whatever you press belongs.',
    ...
    'pick.jazz.d':'🧪 the inner kitchen — the scale follows the chords; you see it first',
    'pick.lab.d':'🧪 the inner kitchen — build your own scale from the 12 notes',
    ...
    'intro.p':'Keys are steps along a scale, not fixed notes. Pick an instrument:',
  ...
  ru: {
    ...
    'howit.p3':'Jamlab оставляет только ноты выбранного стиля. Что ни нажмёшь — всё в кассу.',
    ...
    'pick.jazz.d':'🧪 внутренняя кухня — лад сам едет по аккордам; вы видите это первыми',
    'pick.lab.d':'🧪 внутренняя кухня — собери собственный звукоряд из 12 нот',
    ...
    'intro.p':'Клавиши — шаги по гамме, а не фиксированные ноты. Выбери инструмент:',
  ...
  es: {
    ...
    'howit.p3':'Jamlab deja solo las notas del estilo elegido. Pulses lo que pulses, encaja.',
    ...
    'howit.g':'Chuleta',
    'howit.g1':'Drone — una nota infinita de fondo, como una gaita.',
    ...
    'backdesc.both':'Drone y arpegio a la vez.',
    ...
    'pick.jazz.d':'🧪 la cocina interna — la escala sigue los acordes; lo ves primero',
    'pick.lab.d':'🧪 la cocina interna — crea tu propia escala con las 12 notas',
    ...
    'intro.p':'Las teclas son pasos por la escala, no notas fijas. Elige un instrumento:',
    ...
    'pick.jazz.m':'sótano humeante, contrabajo',
  },
  pt: {
    ...
    'howit.p3':'O Jamlab mantém só as notas do estilo escolhido. O que você tocar, encaixa.',
    ...
    'backdesc.padperc':'Pad suave mais baixo e percussão.',
    'backdesc.arpperc':'Arpejo em loop mais baixo e percussão.',
    ...
    'pick.jazz.d':'🧪 a cozinha interna — a escala segue os acordes; você vê primeiro',
    'pick.lab.d':'🧪 a cozinha interna — monte sua própria escala com as 12 notas',
    ...
    'intro.p':'As teclas são passos pela escala, não notas fixas. Escolha um instrumento:',
  ...
  de: {
    ...
    'howit.p3':'Jamlab behält nur die Töne des gewählten Stils. Was immer du drückst — es passt.',
    ...
    'backdesc.gong':'Ein langsamer Gong-Zyklus hält die Zeit.',
    ...
    'role.stepN':'Stufe {n}',
    'variant.freygish':'Hijaz','variant.hungarian':'Zigeunermoll','variant.romanian':'Klezmer',
    'pick.jazz.d':'🧪 die interne Küche — die Tonleiter folgt den Akkorden; du siehst es zuerst',
    'pick.lab.d':'🧪 die interne Küche — baue deine eigene Tonleiter aus den 12 Tönen',
    'mode.jazz.sub':'· Auto-Tonleiter · 🧪 interne Küche',
    'pw.li1':'Fünf weitere Instrumente: Blues, Orient, Traum, Gamelan, Synthwave',
    'pw.li2':'🧪 Schlüssel zur Küche: Jazz und das Tonleiter-Labor — Experimente aus erster Hand',
    'intro.hero':'Hier gibt es keinen falschen Ton.',
    'intro.p':'Die Tasten sind Schritte auf der Tonleiter, keine festen Töne. Wähle ein Instrument:',
  ...
  fr: {
    ...
    'howit.p3':'Jamlab ne garde que les notes du style choisi. Quoi que tu presses, ça tombe juste.',
    ...
    'howit.g':'Antisèche',
    'howit.g1':'Drone — une note infinie en fond, comme une cornemuse.',
    'howit.g2':"Arpège — l'accompagnement égrène en boucle les notes de ta gamme.",
    'howit.g3':'Bend — faire glisser la hauteur de la note, comme un guitariste tire la corde.',
    ...
    'backdesc.both':'Drone et arpège ensemble.',
    ...
    'pick.jazz.d':'🧪 la cuisine interne — la gamme suit les accords ; tu le vois en premier',
    'pick.lab.d':'🧪 la cuisine interne — construis ta gamme avec les 12 notes',
    ...
    'intro.p':'Les touches sont des pas le long de la gamme, pas des notes fixes. Choisis un instrument :',
  ...
  ja: {
    ...
    'howit.p3':'Jamlabは選んだスタイルの音だけを残します。何を押しても合うのです。',
    ...
    'pick.jazz.d':'🧪 内部キッチン — 音階がコードを追いかける。最初に見られるのはあなた',
    'pick.lab.d':'🧪 内部キッチン — 12音から自分の音階を作ろう',
    ...
    'intro.p':'キーは固定の音ではなく、音階の歩み。楽器を選んでください：',
  ...
  zh: {
    ...
    'howit.p3':'Jamlab只保留所选风格的音。随便按，都在调上。',
    ...
    'pick.jazz.d':'🧪 内部厨房——音阶跟着和弦走；你最先看到',
    'pick.lab.d':'🧪 内部厨房——用12个音打造你自己的音阶',
    'mode.jazz.sub':'· 和弦自动音阶 · 🧪 内部厨房',
    'pw.li1':'再加五件乐器：布鲁斯、东方、梦境、甘美兰、合成波',
    'pw.li2':'🧪 厨房钥匙：爵士与音阶实验室——抢先体验实验品',
    'intro.hero':'在这里不存在错音。',
    'intro.p':'琴键是沿音阶走的步子，不是固定的音。选择一件乐器：',
    'pick.again':'再点一次进入',
