...
const X = {
  en: {
    ...
    'ctl.instr':'Instrument','instr.original':'Synth','btn.toInstr':'◀ Instrument',
    'instr.piano':'Grand piano','instr.epiano':'E-piano','instr.harpsi':'Harpsichord','instr.celesta':'Celesta','instr.musicbox':'Music box','instr.vibes':'Vibraphone','instr.marimba':'Marimba','instr.glock':'Glockenspiel','instr.kalimba':'Kalimba','instr.organ':'Organ','instr.accordion':'Accordion','instr.harmonica':'Harmonica','instr.nylon':'Nylon guitar','instr.steel':'Steel guitar','instr.harp':'Harp','instr.sitar':'Sitar','instr.koto':'Koto','instr.shamisen':'Shamisen','instr.strings':'Strings','instr.choir':'Choir','instr.flute':'Flute','instr.panflute':'Pan flute','instr.shaku':'Shakuhachi','instr.clarinet':'Clarinet','instr.sax':'Sax','instr.trumpet':'Trumpet',
  ...
  ru: {
    ...
    'howit.p1':'В октаве 12 равных полутонов. Чтобы импровизировать, нужно знать, какие из них сочетаются между собой, — иначе выходит фальшь.',
    ...
    'ctl.instr':'Инструмент','instr.original':'Синтез','btn.toInstr':'◀ Инструмент',
    'instr.piano':'Рояль','instr.epiano':'Электропиано','instr.harpsi':'Клавесин','instr.celesta':'Челеста','instr.musicbox':'Музыкальная шкатулка','instr.vibes':'Вибрафон','instr.marimba':'Маримба','instr.glock':'Глокеншпиль','instr.kalimba':'Калимба','instr.organ':'Орган','instr.accordion':'Аккордеон','instr.harmonica':'Губная гармошка','instr.nylon':'Нейлон-гитара','instr.steel':'Стил-гитара','instr.harp':'Арфа','instr.sitar':'Ситар','instr.koto':'Кото','instr.shamisen':'Сямисэн','instr.strings':'Струнные','instr.choir':'Хор','instr.flute':'Флейта','instr.panflute':'Пан-флейта','instr.shaku':'Сякухати','instr.clarinet':'Кларнет','instr.sax':'Саксофон','instr.trumpet':'Труба',
