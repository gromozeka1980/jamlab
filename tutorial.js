...
const X = {
  en: {
    ...
    'kd.t':'🧪 The Kitchen','kd.d':'a separate door — new instruments are brewed and tested here','kd.sub':'Everything here is alive: it changes, it sometimes breaks — and you see it first.','kd.back':'← Back',
  ...
  ru: {
    ...
    'kd.t':'🧪 Кухня','kd.d':'отдельная дверь — здесь варятся и тестируются новые инструменты','kd.sub':'Здесь всё живое: меняется, иногда ломается — зато вы видите это первыми.','kd.back':'← Назад',
  ...
  es: {
    ...
    'kd.t':'🧪 La Cocina','kd.d':'una puerta aparte — aquí se cuecen y prueban instrumentos nuevos','kd.sub':'Aquí todo está vivo: cambia, a veces se rompe — y tú lo ves primero.','kd.back':'← Atrás',
  ...
  pt: {
    ...
    'kd.t':'🧪 A Cozinha','kd.d':'uma porta à parte — novos instrumentos são preparados e testados aqui','kd.sub':'Aqui tudo está vivo: muda, às vezes quebra — e você vê primeiro.','kd.back':'← Voltar',
  ...
  de: {
    ...
    'pick.jazz.d':'die Tonleiter folgt den Akkorden (goldene Sequenz)',
    'kd.t':'🧪 Die Küche','kd.d':'eine eigene Tür — hier werden neue Instrumente gebraut und getestet','kd.sub':'Hier ist alles lebendig: es ändert sich, manchmal bricht etwas — und du siehst es zuerst.','kd.back':'← Zurück',
    'pick.lab.d':'baue deine eigene Tonleiter aus den 12 Tönen',
  ...
  fr: {
    ...
    'kd.t':'🧪 La Cuisine','kd.d':"une porte à part — de nouveaux instruments s’y préparent et s’y testent",'kd.sub':'Ici tout est vivant : ça change, parfois ça casse — et tu le vois en premier.','kd.back':'← Retour',
  ...
  ja: {
    ...
    'kd.t':'🧪 キッチン','kd.d':'別の扉 — 新しい楽器はここで仕込まれ、試されます','kd.sub':'ここは生きています。変わり、ときに壊れます — 最初に見るのはあなた。','kd.back':'← 戻る',
  ...
  zh: {
    ...
    'kd.t':'🧪 厨房','kd.d':'一扇单独的门——新乐器在这里酿造与测试','kd.sub':'这里的一切都是活的：会变化，偶尔会坏——而你最先看到。','kd.back':'← 返回',
